...
import "./NavBar.css";
import { faCirclePlus,  faCloudUpload, faDatabase, faEdit, faTableList, faSackDollar } from "@fortawesome/free-solid-svg-icons";
...
const navigationItems = [
  ...
  { path: "/recaudacion", label: "recaudacion", icon: faSackDollar },
];
